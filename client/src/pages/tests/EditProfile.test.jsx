...
describe('EditProfile', () => {
  ...
  it('should update the password and navigate to the profile page', async () => {
    const mockToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NjBiYjI2OWFkNjVhOTdiNWI2MTk5N2MiLCJyb2xlIjoic2VydmljZV9wcm92aWRlciIsImlhdCI6MTcxMjA0MjY2OSwiZXhwIjoxNzEyMTI5MDY5fQ.OgV7--alafh_j-XJH4lXuZppXKUaMiCCWaoM-3SeoP4';
    ...
    fireEvent.change(newPasswordInput, { target: { value: 'password123update' } });
    ...
    await waitFor(() => {
      ...
      expect(mockNavigate).toHaveBeenCalledWith('/profile', { state: { passwordUpdated: true } });
    });
  });
});